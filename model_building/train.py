...
ngrok.set_auth_token("3F4pwjkSbQ8haRqVxCBOj5lhw5i_3GTAi5xyq5Lpyg5HAr7Ak")
...
ytrain_path = "hf://datasets/Pammi123/engine-health-prediction/ytrain.csv"
ytest_path = "hf://datasets/Pammi123/engine-health-prediction/ytest.csv"
...
preprocessor = make_column_transformer(
    (StandardScaler(), ind_features))

# Defining base XGBoost model
xgb_model = xgb.XGBClassifier(scale_pos_weight=class_weight, random_state=30)
...
with mlflow.start_run():
    ...
    # create_repo("engine-model", repo_type="model", private=False)
    api.upload_file(
